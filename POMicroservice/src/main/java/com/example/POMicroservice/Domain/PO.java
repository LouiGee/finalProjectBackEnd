...
public class PO {
    ...
    public PO( String PONumber, String POItemNumber, String Company, String Item, String Unit, int Quantity , double Price, LocalDateTime dateRaised, String Status, String raisedBy, String approvedBy, LocalDateTime dateApproved, String description ) {
