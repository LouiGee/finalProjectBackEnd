...
public class POTempProviderPactTest {
    ...
    @State("Temp POs exist")
    public void setupPOTempExist() {
    ...
    @State("There are temporary POs ready to submit")
    public void setupPOTempSubmit() {
        POTemp PO1 = new POTemp("JohnDepartmentAnalyst@cookfood.com", "Company1", "Item", "Kg", 5, 10.00,"test");
        POTemp PO2 = new POTemp("JohnDepartmentAnalyst@cookfood.com", "Company2", "Item", "Kg", 20, 10.00, "test");
        POTemp PO3 = new POTemp("JohnDepartmentAnalyst@cookfood.com", "Company3", "Item", "Kg", 20, 10.00, "test");
    ...
    @State("A temp PO exists to delete")
    public void setupPOTempDelete() {
        POTemp PO1 = new POTemp("JohnDepartmentAnalyst@cookfood.com", "Company1", "Item", "Kg", 5, 10.00,"Test");
    ...
    @State("A new POTemp can be created without returning body")
    public void setupPOTempCreate() {

    }

    @State("A POTemp exists to be updated")
    public void setupPOTempUpdate() {
        POTemp existingPO = new POTemp("JohnDepartmentAnalyst@cookfood.com", "Company1", "Item", "Kg", 5, 10.00, "Test");poTempService.createPOTemp(existingPO);
