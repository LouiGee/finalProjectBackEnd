...
class POServiceIntegrationTest {
    ...
    void setUp() {
        ...
        // Add test POs
        poRepository.save(new PO("PO1", "PO1-01", "Company3", "Item", "Kg", 20, 10.00, LocalDateTime.now(), "awaiting-approval", "JohnDepartmentAnalyst@cookfood.com", "", LocalDateTime.now()));
        poRepository.save(new PO("PO1", "PO1-02", "Company2", "Item", "Kg", 20, 10.00, LocalDateTime.now(), "approved", "JohnDepartmentAnalyst@cookfood.com", "", LocalDateTime.now()));
    }
