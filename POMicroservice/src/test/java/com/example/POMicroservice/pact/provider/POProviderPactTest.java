...
public class POProviderPactTest {
    ...
    private String fetchJwtToken() throws Exception {
        ...
        loginPayload.put("email", "JohnDepartmentAnalyst@cookfood.com");
        loginPayload.put("password", "Analyst12345");
    ...
    void pactVerificationTest(PactVerificationContext context , ClassicHttpRequest request) {
        ...
        request.addHeader("Cookie", "authenticationToken=" + jwtToken);
    ...
    public void setupPOsExist() {
        POTemp PO1 = new POTemp("JohnDepartmentAnalyst@cookfood.com", "Company1", "Item", "Kg", 5, 10.00);
