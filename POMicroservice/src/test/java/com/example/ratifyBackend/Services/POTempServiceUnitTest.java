...
class POTempServiceUnitTest {
    ...
    void returnAllPOTemp() {
        ...
        List<POTemp> result = poTempService.getAllTempPO();
    ...
    void CopyTempPOBasket() {
        ...
        List<POTemp> result1 = poTempService.getAllTempPO();

        assertThat(result1).hasSize(1);

        PO PO2 = new PO("PO1", "PO1-1", "Company3", "Item", "Kg", 20, 10.00, LocalDateTime.now(), "Awaiting-Approval", "JohnDepartmentAnalyst@cookfood.com", "", LocalDateTime.now());
