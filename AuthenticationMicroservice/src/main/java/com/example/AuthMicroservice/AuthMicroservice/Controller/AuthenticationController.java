package com.example.AuthMicroservice.AuthMicroservice.Controller;
...
public class AuthenticationController {
    ...
    @PostMapping("/login")
    public ResponseEntity<?> login(@RequestBody AuthenticationRequest request, @CookieValue(name = "authenticationToken", required = false) String authenticationToken ) {
