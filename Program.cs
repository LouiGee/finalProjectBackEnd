...
builder.Services.AddDbContext<PaymentRecordDbContext>(options =>
...
builder.Services.AddScoped<TinkPaymentIdService>();
builder.Services.AddScoped<TinkBulkPaymentService>();
