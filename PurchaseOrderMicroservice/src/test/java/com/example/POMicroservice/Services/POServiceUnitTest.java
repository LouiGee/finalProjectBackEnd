...
class POServiceUnitTest {
    ...
    void getAllPO_shouldReturnAllPOs() {
        ...
        PO po1 = new PO("PO1", "PO1-01", "Company3", "Item", "Kg", 20, 10.00, LocalDateTime.now(), "JohnDepartmentAnalyst@cookfood.com",  "awaiting-approval",  "");
        PO po2 = new PO("PO1", "PO1-02", "Company2", "Item", "Kg", 20, 10.00, LocalDateTime.now(), "JohnDepartmentAnalyst@cookfood.com", LocalDateTime.now(), "JohnDepartmentAnalyst@cookfood.com", "approved",  "");

        List<PO> poList = List.of(po1, po2);
    ...
    void getAllApprovedPO_shouldReturnOnlyApprovedPOs() {
        ...
        PO po = new PO("PO1", "PO1-02", "Company2", "Item", "Kg", 20, 10.00, LocalDateTime.now(),
                "JohnDepartmentAnalyst@cookfood.com", LocalDateTime.now(),
                "JohnDepartmentAnalyst@cookfood.com", "approved", "");

        List<PO> approvedList = List.of(po);
